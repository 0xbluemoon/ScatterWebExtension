...
export default {
    ...
    [KEYS.BUTTON_DestroyScatter]:'Destroy Chrove',
    [KEYS.BUTTON_CreateNewScatter]:'Create New Chrove',
    [KEYS.BUTTON_LoadFromBackup]:'Load From Backup',
    [KEYS.BUTTON_Unlock]:'Unlock',
    [KEYS.BUTTON_ExportScatter]:'Export Chrove',
    ...
    [KEYS.HISTORIES_Description]:`
        Once you have them, you will be able to see a list of all of the events that pass through your Chrove.
        What you will not see is events that occurred on your accounts outside of Chrove.
     `,
    [KEYS.HISTORIES_Note]:`
        Note: Exporting your Chrove data from the backup option in the settings panel does not save these events.
        When you import that Chrove instance again your histories will be empty. If you would like to export your histories
    ...
    [KEYS.BACKUP_Description]:`
        Exporting your Chrove allows you to import it into other devices. The file will still be encrypted when it is 
    ...
    [KEYS.IMPORT_Description]:`
        Importing your encrypted keychain file will rebuild you Chrove keychain but it will not import your old networks or 
        accounts. 
    `,
    ...
    [KEYS.DESTROY_Header]:`Destroying Chrove`,
    [KEYS.DESTROY_Description]:`
        You are about to destroy your entire Chrove keychain. The only way to get this exact Chrove back is by 
        importing an exported Chrove JSON. You will not be able to claim your identities otherwise. Make sure you 
        have exported your Chrove from the backup settings panel before hand.
    `,
    ...
    `,
    [KEYS.KEYPAIR_Important]:`Save your private key elsewhere! You can not take private keys back out of Chrove.`,
    ...
    [KEYS.LOCK_Description]:`
        Auto Lock handles Chrove's locking for you so that you don't have to 
        remember to lock your Chrove when you step away.
    `,
    ...
    [KEYS.MNEMONIC_Description]:`Mnemonics in Chrove are only used for password recovery.`,
    [KEYS.MNEMONIC_Note]:`
        Be sure to save yours somewhere safe. It is the only way to regain access to your 
        Chrove and decrypt your private information if you forget your password.
    `,
    ...
    [KEYS.ALERT_RemovingEndorsedNetwork]:[
        ...
        `You cannot remove Chrove's endorsed Networks.`
    ],
    //2
    ...
    [KEYS.REQUEST_AddNetwork]:[
        /*{DOMAIN}*/ 'wants to add their network to your Chrove.',

        'Some applications use their own Networks.',

        `This in no way gives the application any access to your Chrove. 
    ...
    [KEYS.REQUEST_ScatterIsLocked]:[
        `Your Chrove is locked!`,

        `Before you can do anything with your Chrove you will need to unlock it.`,
        ...
        `If you see a prompt/popup which is requesting your password, it is a malicious website trying to get your password.
         Always only unlock Chrove from the extension's popup by clicking on the icon in your browser tray.`
    ],
    //4
    [KEYS.REQUEST_UpdateVersion]:[
        `Your Chrove is out of date!`,

        /*{DOMAIN}*/ `is requiring you have a version of Chrove that is newer than the one installed.`,
        ...
        `Please Note, we leave version checking up to the applications themselves. They could be maliciously trying to
         get you to download something. Make sure you always download Chrove from the proper location.`
    ],
