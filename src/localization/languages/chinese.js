...
export default {
    ...
    [KEYS.BUTTON_DestroyScatter]:'删除 Chrove',
    [KEYS.BUTTON_CreateNewScatter]:'创建新的 Chrove',
    [KEYS.BUTTON_LoadFromBackup]:'从备份中恢复',
    [KEYS.BUTTON_Unlock]:'解锁',
    [KEYS.BUTTON_ExportScatter]:'导出 Chrove',
...
     `,
    ...
    [KEYS.HISTORIES_Description]:`
        在此您能看到所有 Chrove 的事件列表.
        但在您的 Chrove 外的帐户上发生的事件不会显示.
     `,
    [KEYS.HISTORIES_Note]:`
        注意：当从设置面板中的备份选项中导出您的 Chrove 数据时，不会备份这些事件。
    ...
    [KEYS.BACKUP_Description]:`
        导出您的 Chrove 后，您将可以将其导入其他设备。导出文件将被加密，
    ...
    [KEYS.IMPORT_Description]:`
        导入你的加密钥匙串文件将重建您的 Chrove 钥匙串，但是它不会导入您原有的网络
        或帐户设置
    `,
    ...
    [KEYS.DESTROY_Header]:`销毁 Chrove`,
    [KEYS.DESTROY_Description]:`
        您即将销毁您的整个 Chrove 钥匙串。恢复 Chrove 的唯一方法是
        导入以前导出的 Chrove JSON 文件。 否则你将没有办法再使用你的身份。
        请确保在着手这个操作前，已经从备份设置面板中导出了您的 Chrove。
    `,
    ...
    [KEYS.MNEMONIC_Note]:`
        ...
        这是恢复对 Chrove 的访问和解密您的个人信息的唯一途径。
    `,
...
         此事务的某些属性的更改，并且仅当其他属性发生更改时，
    ...
    [KEYS.REQUEST_UpdateVersion]:[
        ...
        `注意，我们让应用能够检查 Chrove 的版本，但它们有可能让你下载恶意程序，请确保从正确的地址下载 Chrove.`
    ],
