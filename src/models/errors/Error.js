...
export default class Error {
    ...
    static locked(){
        return new Error(ErrorTypes.LOCKED, "The user's Chrove is locked. They have been notified and should unlock before continuing.")
    }
    ...
    static requiresUpgrade(){
        return new Error(ErrorTypes.UPGRADE_REQUIRED, "The required version is newer than the User's Chrove", ErrorCodes.UPGRADE_REQUIRED)
    }
    ...
    static usedKeyProvider(){
        return new Error(
            ...
            "Do not use a `keyProvider` with a Chrove. Use a `signProvider` and return only signatures to this object. A malicious person could retrieve your keys otherwise.",
